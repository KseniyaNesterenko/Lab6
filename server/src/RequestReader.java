...
public class RequestReader {
    ...
    private static final Logger requestReaderLogger = LogManager.getLogger(RequestReader.class);
    ...
    public void readCommand() throws IOException, ClassNotFoundException {
        ...
        requestReaderLogger.info("Получен пакет с командой от " + senderAddress.getHostAddress() + " " + senderPort);

        commandContainer = (CommandContainer) ois.readObject();
        requestReaderLogger.info("Контейнер с командой получен");
    }
